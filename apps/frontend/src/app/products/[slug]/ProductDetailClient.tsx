    ...
    <>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          {/* Left: Product Images with Auto-Heal */}
            ...
            <div className="glass-panel rounded-3xl p-4 sm:p-6 border border-slate-800 relative overflow-hidden group">
              <div className="aspect-square rounded-2xl overflow-hidden bg-slate-950/80 border border-slate-800/80 relative">
                <AutoHealImage
                  src={activeImage}
                  alt={product.title}
                  fallbackCategory={product.category?.name}
              ...
              <div className="flex items-center gap-3 overflow-x-auto pb-2">
                {product.images.map((img, idx) => (
                  <button
                    ...
                    className={`w-16 h-16 rounded-xl overflow-hidden border transition shrink-0 ${
                      activeImage === img
          ...
          {/* Right: Pricing, Multi-Variant Matrix & Controls */}
          <div className="lg:col-span-6 space-y-6">
            <div className="space-y-3">
              <div className="flex items-center justify-between gap-3">
                <div className="flex items-center gap-2">
                  <span className="px-3 py-1 rounded-full bg-amber-500/10 border border-amber-500/30 text-amber-400 text-xs font-black uppercase">
                ...
                <button
                  ...
                  className="px-2.5 py-1 rounded-xl bg-slate-900 border border-amber-500/40 text-amber-400 text-xs font-bold transition flex items-center gap-1.5 hover:bg-slate-800"
                >
                  <Atom className="w-3.5 h-3.5" />
                  <span>Raw Physics Specs</span>
                </button>
              </div>
              ...
              <div className="flex items-baseline gap-4 pt-2">
                ...
                <span className="text-xs text-slate-500 font-mono">
                  SKU: <strong className="text-slate-300">{selectedVariant?.sku || product.sku}</strong>
                </span>
              </div>
            </div>
            ...
            {/* 2. MULTI-SIZE / WEIGHT / PERIMETER PICKER */}
